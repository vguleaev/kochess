...
export const clerkAppearance = {
  ...
  elements: {
    ...
    formFieldInput:
      'h-9 w-full bg-transparent border border-input text-foreground text-base md:text-sm placeholder:text-muted-foreground shadow-xs rounded-md px-3 py-1 transition-[color,box-shadow] outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px]',
    ...
    otpCodeFieldInput:
      'h-9 bg-transparent border border-input text-foreground text-base md:text-sm shadow-xs rounded-md transition-[color,box-shadow] outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px]',
